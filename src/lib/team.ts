...
export const TEAM: TeamMember[] = [
  ...
  },
  {
    ...
    languages:  ['English', 'Hausa', 'Yoruba'],
    achievements: ['Coordinated logistics for 1,500,000+ beneficiaries across 10 states'],
  },
  {
    slug:       'aisha-mohammed',
    name:       'Aisha Mohammed',
    ...
    email:      'aisha@cbi.ngo',
    photo:      '/images/cbi-community-1.jpg',
    accent:     '#d97706',
    level:      'staff',
  ...
  },
  {
    ...
    photo:      '/images/cbi-community-2.jpg',
    accent:     '#e11d48',
    level:      'staff',
    location:   'Abuja, Nigeria',
    yearsAtCBI: 4,
  ...
  },
  {
    ...
    role:       'Field Officer',
    email:      'grace@cbi.ngo',
    photo:      '/images/cbi-mother-baby.jpg',
    accent:     '#7c3aed',
    level:      'staff',
